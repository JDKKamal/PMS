...
public class DayView extends FrameLayout {
    ...
    private void init() {
        ...
        this.tvDay.setTextColor(ContextCompat.getColor(getContext(), R.color.colorWhite));
    ...
    private Drawable getSelectionDrawable() {
        if (_selectionDrawable == null) {
            _selectionDrawable = generateCircleDrawable(ContextCompat.getColor(getContext(), R.color.colorWhite));
        }
